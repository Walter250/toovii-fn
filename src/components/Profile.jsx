...
export default function ProfileMenu() {
  ...
  return (
    <article className="bg-[#242424] absolute top-20 md:top-16 sm:top-14 right-6 md:right-5 sm:right-4 w-1/4 lg:w-1/2 sm:w-4/5 rounded-3xl p-4 border border-mainYellow/30 flex flex-col gap-6 items-start z-40">
